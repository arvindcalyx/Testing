...
object Utils {
    ...
    fun getOutputMediaFileUri(
        ...
        return Uri.fromFile(FileUtils_APP.getExtStorageDirFileForImages(type, context))
    }
     ...
     */
    @JvmStatic
    fun getOutputMediaFileUriForCamera(
        type: String, context: Context
    ): Uri? {
        ...
        return FileProvider.getUriForFile(
                ...
                FileUtils_APP.getExtStorageDirFileForImages(type, context)!!
            )
    }
        ...
        try {
            ...
            if (src.isDirectory()) {
                ...
                for (i in 0 until filesLength) {
                    val src1: String = File(src, files[i]).getPath()
                    val dst1: String = dst.getPath()
    ...
    private fun calculateInSampleSize(
        ...
        Timber.d("$className >> onCreate() >> Image -> Height: $height, Width: $width")
        ...
        Timber.d("$className >> calculateInSampleSize: $inSampleSize")
     ...
     */
    public fun setAnimation(context: Context?,viewToAnimate: View, position: Int) {
